            ...
            <section className='bg-slate-200'>
                <div className='flex flex-col bg-slate-200 gap-y-8 max-w-header'>
                    {ServicesData.map((x, index) => {
                        return (
                            <motion.div id={index} key={index} className='bg-white gap-y-8 flex justify-around p-8 max-lg:flex-col  max-lg:items-center'
                                initial={{ opacity: 0 }}
                            ...
                            >
                                <div className='flex flex-col  max-w-sm gap-y-4 max-lg:max-w-4xl '>
                                    ...
                                    <div className='flex  items center max-lg:justify-center'>
                                        <div className='px-20 py-2 text-white max-w-sm bg-color-golden text-center hover-btn-a'>AGENDA TU CITA</div>
                                    </div>
                                </div>
                                <div className='flex flex-col text-neutral-700 max-w-xs bg-neutral-200 p-4 max-lg:max-w-4xl items-start  justify-center  max-lg:items-center w-full'>
                                    {x.descT.map((x, index) => {
                                        return (
                                            <motion.p 
                                            key={index}
